# Attenuation of Post-Synaptic Potentials in a Passive Dendrite

In this repository we collect code which allows to define a passive chain of compartments for experiments on BrainScaleS-2 as well as simulations in [Arbor](https://arbor-sim.org/).
It furthermore provides code to classify the attenuation of excitatory post-synaptic potentials along the chain of compartments and visualize these results.
...
c ./waf setup --repo-db-url=https://github.com/electronicvisions/projects --project=model-hw-mc-attenuation
...
## License
```
PSP attenuation along passive dendrite ('model_hw_mc_attenuation')
